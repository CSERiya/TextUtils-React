	...
	return (
		<>
			...
			<div className={`accordion my-3 text-${darkOnLight}`} id="faqAccordion">
				<Accordion mode={mode} header="How this website works?" body={<>Initially, put some text in the text box 
        then, choose the operation you wants to perform with your text. Then, text summary will provide some
         details about your text.</>} count="One" accordionId="#faqAccordion" />
